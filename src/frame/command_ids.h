...
constexpr int kOptionsSaveTabsLocal = 2474;
constexpr int kOptionsSaveTabsOffline = 2475;
constexpr int kOptionsSaveTabsRemote = 2476;
constexpr int kOptionsSaveTabsSearch = 2477;
constexpr int kOptionsSaveTabsCompare = 2478;
constexpr int kOptionsSaveTabsRegFile = 2479;
constexpr int kOptionsEditContextMenu = 2480;
...
constexpr int kOptionsIconSetNative = 2485;
constexpr int kOptionsIconSetClassic = 2486;
