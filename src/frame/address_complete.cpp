...
{
  public:
    RegistryAddressEnum(MainWindow::Impl* owner, HWND edit)
...
BOOL CALLBACK ApplyAutoCompleteThemeProc(HWND hwnd, LPARAM lparam)
{
    ...
    bool is_dropdown = WindowClassEquals(hwnd, L"Auto-Suggest Dropdown") || WindowClassEquals(hwnd, L"Autocomplete") ||
                       WindowClassEquals(hwnd, L"AutoComplete");
    if (!is_dropdown)
    {
