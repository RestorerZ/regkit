...
constexpr std::array<ResearchLink, 22> kLinks = {{
    ...
    {L"Accessibility Values",
     L"https://noverse.dev/docs/win-config/system/disable-accessibility-features/#systemsettings-captures"},
    ...
    {L"UserPreferenceMask Bitmask",
     L"https://noverse.dev/docs/win-config/visibility/minimal-visual-effects/#userpreferencesmask"},
    {L"DiagnosticDataSettings Values",
     L"https://noverse.dev/docs/win-config/privacy/disable-general-telemetry/#diagnosticdatasettings-values"},
    {L"SubscribedContent IDs",
     L"https://noverse.dev/docs/win-config/privacy/disable-suggestions-tips-tricks/#subscribedcontent-ids"},
    ...
    {L"Windows Security Values",
     L"https://noverse.dev/docs/win-config/security/windows-defender/#windows-security-captures"},
}};
