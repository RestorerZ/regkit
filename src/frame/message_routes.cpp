...
LRESULT MainWindow::Impl::HandleMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleLifecycleMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleLayoutInputMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
void MainWindow::Impl::FinishSearchSession(
    uint64_t generation
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleSearchWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleLoadWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleRegFileWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleTraceWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleDefaultWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleValueWorkerMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleExternalMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleAppearanceMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
...
std::optional<LRESULT> MainWindow::Impl::HandleBrowseMessage(
    UINT message,
    WPARAM wparam,
    LPARAM lparam
) {
  ...
  case WM_COMMAND:
    {
      ...
      if (HIWORD(wparam) == EN_CHANGE && LOWORD(wparam) == kFilterEditId) {
        ...
        if (needs_full_data) {
          needs_full_data = std::any_of(browse_.values().rows().begin(), browse_.values().rows().end(), [](const ListRow& row) { return row.kind == rowkind::kValue && !row.data_ready; });
        }
