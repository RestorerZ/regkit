...
bool ShowReplaceDialog(
  ...
  return result && appearance::RunDialogWindow(&state, kDialogClass, ReplaceDialogProc, L"Replace", {appearance::metrics::Scaled(520, dpi), appearance::metrics::Scaled(360, dpi)});
}
